...
QT_MOC_LITERAL(8, 13), // "sigChangeSkin"
QT_MOC_LITERAL(22, 0), // ""
QT_MOC_LITERAL(23, 5), // "color"
QT_MOC_LITERAL(29, 1) // "c"

    },
    "setting\0sigChangeSkin\0\0color\0c"
};
...
void setting::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sigChangeSkin((*reinterpret_cast< std::add_pointer_t<color>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (setting::*)(color );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&setting::sigChangeSkin)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<setting, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<color, std::false_type>
...
// SIGNAL 0
void setting::sigChangeSkin(color _t1)
{
