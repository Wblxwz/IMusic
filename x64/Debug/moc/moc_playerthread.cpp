...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_PlayerThread_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_PlayerThread_t qt_meta_stringdata_PlayerThread = {
    {
QT_MOC_LITERAL(0, 12) // "PlayerThread"
...
const QMetaObject PlayerThread::staticMetaObject = { {
    ...
    qt_meta_stringdata_PlayerThread.offsetsAndSize,
    qt_meta_data_PlayerThread,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_PlayerThread_t
, QtPrivate::TypeAndForceComplete<PlayerThread, std::true_type>
